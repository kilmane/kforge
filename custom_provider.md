...
Custom is designed for advanced users, enterprise setups, self-hosted gateways, and anyone who wants full control.
...
All of that depends entirely on your endpoint and your provider account.
...
Select Custom Endpoint (OpenAI-compatible) as the provider
...
Add or select a model ID supported by your endpoint
...
Model tags and tiers (important)
...
Cheap or free models, safe to iterate and experiment



Free

No billing required, often rate-limited or restricted



Main

Daily driver models with reasonable cost and capability
...
Pricing or limits unclear — check provider documentation
